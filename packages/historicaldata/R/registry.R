...
hd_macro_registry <- function() {
  tibble::tribble(
    ...
    "DGS20",             "20Y Treasury Constant Maturity Yield",    "20-year Treasury yield (constant maturity, daily)",   "yield_curve",   "daily",     TRUE,             TRUE,            1993L,       "US Treasury",         "fred",        "Treasury term structure; NA 1987-02-19 to 1993-09-30 (series discontinued and reactivated)", "high",
    # ---- Inflation ----
    ...
    "DEXUSEU",           "USD per EUR (daily)",                     "U.S. Dollars to Euro Spot Exchange Rate (Daily)",     "currency",      "daily",     FALSE,            FALSE,           1999L,       "Federal Reserve H.10","fred",        "post-EUR-inception leg of the 1970-present EUR/USD chain (pair with DEXGEUS pre-1999)", "high",
    "DEXGEUS",           "DM per USD (daily, legacy)",              "German Marks to U.S. Dollar Exchange Rate (Daily)",   "currency",      "daily",     FALSE,            FALSE,           1971L,       "Federal Reserve H.10","fred",        "pre-1999 leg of EUR/USD chain; series discontinued 1998-12-31, splice to DEXUSEU at 1.95583 DEM/EUR", "high",
    # ---- Housing / money ----
