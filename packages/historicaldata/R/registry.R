...
hd_macro_registry <- function() {
  tibble::tribble(
    ...
    "DGS20",             "20Y Treasury Constant Maturity Yield",    "20-year Treasury yield (constant maturity, daily)",   "yield_curve",   "daily",     TRUE,             TRUE,            1993L,       "US Treasury",         "fred",        "Treasury term structure",            "high",
    # ---- Inflation ----
