...
hd_macro_registry <- function() {
  tibble::tribble(
    ...
    "BXM",               "CBOE BuyWrite Monthly Index",             "S&P 500 Covered Call Strategy Return (Monthly ATM)",  "options_strategy",     "daily",     FALSE,            FALSE,           2002L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "BXY",               "CBOE 2% OTM BuyWrite Index",              "S&P 500 Covered Call Strategy Return (2% OTM)",       "options_strategy",     "daily",     FALSE,            FALSE,           1988L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "BXMD",              "CBOE 30-Delta BuyWrite Index",            "S&P 500 Covered Call Strategy Return (30-Delta)",     "options_strategy",     "daily",     FALSE,            FALSE,           1986L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "BXMC",              "CBOE Midpoint BuyWrite Index",            "S&P 500 Covered Call Strategy Return (Midpoint)",     "options_strategy",     "daily",     FALSE,            FALSE,           1990L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "BXMW",              "CBOE Weekly BuyWrite Index",              "S&P 500 Weekly Covered Call Strategy Return",         "options_strategy",     "daily",     FALSE,            FALSE,           2012L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "PUT",               "CBOE PutWrite Monthly Index",             "S&P 500 Cash-Secured Put Strategy Return (Monthly)",  "options_strategy",     "daily",     FALSE,            FALSE,           1991L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "WPUT",              "CBOE Weekly PutWrite Index",              "S&P 500 Weekly Put Write Strategy Return",            "options_strategy",     "daily",     FALSE,            FALSE,           2006L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "PPUT",              "CBOE Protective Put Index",               "S&P 500 with 5% OTM Put Protection Return",           "options_strategy",     "daily",     FALSE,            FALSE,           1986L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "CLL",               "CBOE 95-110 Collar Index",                "S&P 500 Collar Strategy Return (95% Put / 110% Call)","options_strategy",     "daily",     FALSE,            FALSE,           2008L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "CLLZ",              "CBOE Zero-Cost Collar Index",             "S&P 500 Zero-Premium Collar Strategy Return",         "options_strategy",     "daily",     FALSE,            FALSE,           1986L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "BFLY",              "CBOE Iron Butterfly Index",               "S&P 500 Iron Butterfly Strategy Return",              "options_strategy",     "daily",     FALSE,            FALSE,           1986L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    "CNDR",              "CBOE Iron Condor Index",                  "S&P 500 Iron Condor Strategy Return",                 "options_strategy",     "daily",     FALSE,            FALSE,           1986L,       "CBOE",                "cboe",        NA_character_,                                      "high",
    ...
    "LOVOL",             "CBOE Long Volatility Index",              "Systematic Long VIX Futures Strategy Return",         "vol_strategy",         "daily",     FALSE,            FALSE,           2006L,       "CBOE",                "cboe",        NA_character_,                                      "medium",
    "SHORTVOL",          "CBOE Short VIX Futures Index",            "Systematic Short VIX Futures Strategy Return",        "vol_strategy",         "daily",     FALSE,            FALSE,           2005L,       "CBOE",                "cboe",        NA_character_,                                      "medium"
  )
}
