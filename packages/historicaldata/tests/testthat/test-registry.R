test_that("hd_datasets returns expected structure", {
  ...
  expect_named(ds, c("equity_daily", "crypto_daily", "macro_daily", "factors", "macro_vintages", "metadata", "metadata_amendments", "jst_macrohistory", "alphavantage_daily", "kraken_ohlcvt"), ignore.order = TRUE)
