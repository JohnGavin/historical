# check_cmr_effective_breadth throws and names the worst offender when n_eff falls below the floor on a held date
    ...
    Condition
      ...
      i check_cmr_effective_breadth() (S24, #751 item F) guards the fundamental-law breadth floor -- see CMR_MIN_EFFECTIVE_BREADTH's roxygen (R/plan_qa_gates.R) for the derivation.
