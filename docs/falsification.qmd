  ...
  dashboard:
    ...
    include-in-header:
      - text: |
          ...
          // Render mermaid on tab show (hidden tabs cause render failure)
          async function renderMermaid() {
            document.querySelectorAll('pre.mermaid').forEach(function(el) {
              if (el.getAttribute('data-processed')) return;
              // Decode HTML entities that Pandoc injects
              var text = el.textContent || el.innerText;
              el.removeAttribute('data-processed');
            });
            try { await mermaid.run({querySelector:'pre.mermaid'}); } catch(e) { console.log('mermaid initial run:', e); }
          }
          // Run on load for visible tabs
          document.addEventListener('DOMContentLoaded', function() { setTimeout(renderMermaid, 500); });
          // Re-run when tabs are shown (Bootstrap tab events)
          document.addEventListener('shown.bs.tab', function() { setTimeout(renderMermaid, 200); });
          </script>
          <style>
          ...
          /* DT dark mode — mandatory contrast fix */
          ...
          .dataTables_wrapper input[type="search"], .dataTables_wrapper .form-control {
            background-color: #16213e !important; color: #e0e0e0 !important;
            border-color: #444 !important;
          }
          /* Caption font-size consistency */
          .card-body caption, .tab-pane caption, .dataTables_wrapper caption {
            font-size: inherit !important; color: #e0e0e0 !important;
            caption-side: top !important; text-align: left !important;
          }
          table caption { caption-side: top !important; }
          /* BUG 5 fix: dark mode card text contrast */
          [data-bs-theme="dark"] .card-body,
          [data-bs-theme="dark"] .tab-pane {
            color: #e0e0e0 !important;
          }
          /* Font consistency for dashboard cards/warnings */
