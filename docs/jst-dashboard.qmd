...
# Path-checked store + utils (cwd is docs/ under quarto render, project root
# under tar_make). Same pattern as falsification.qmd and momentum-prepeak.qmd.
...
# Load jst_* targets with RDS fallback (inst/extdata/vignettes/) for pkgdown builds
