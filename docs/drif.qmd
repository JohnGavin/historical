...
**Factor-level implementation:** Each month, use an expanding-window elastic net to predict next month's factor return from the past 21 daily returns. Go long the top-2 predicted factors. Monthly rebalance.
